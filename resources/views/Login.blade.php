...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="{{URL::to('/')}}/login_data" method="POST">
                @csrf
                <div class="form-floating">
                    <input type="text" class="form-control" id="email" name="email" placeholder="Enter your email/phonenumber">
                ...
                not registerd? <a href="Register">Register</a>
            </p>
                <div align="center">
